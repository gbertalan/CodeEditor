...
public class MouseListener extends MouseAdapter {
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        } else if (hoveredComponents.contains(listener.maxButton) || (hoveredComponents.contains(listener.titleBar) && e.getClickCount() == 2)) {
    ...
    private boolean isOnWindowControlButton() {
        return hoveredComponents.contains(listener.trayButton) || hoveredComponents.contains(listener.maxButton) || hoveredComponents.contains(listener.closeButton);
    }

    private boolean isOnWindowEdge() {
        return hoveredComponents.contains(listener.edgeWest) || hoveredComponents.contains(listener.edgeNorth) || hoveredComponents.contains(listener.edgeEast) || hoveredComponents.contains(listener.edgeSouth);
    }

    @Override
    public void mouseReleased(MouseEvent e) {
        if (listener.draggingByTitleBar) listener.draggingByTitleBar = false;
